...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderHeader" runat="server">
    <h2 class="pageheader">Redigera nothäfte</h2>
</asp:Content>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderMain" runat="server">
    <div class="row">
        <div class="small-12 large-10 columns booklet-edit-card">
            ...
            <asp:PlaceHolder ID="SuccessMessagePlaceHolder" runat="server" Visible="false">
                <div data-alert="data-alert" class="alert-box success">
                    ...
                    <asp:HyperLink ID="CloseHyperLink" CssClass="close" NavigateUrl='<%# GetRouteUrl("BookletEdit", new { id = Page.RouteData.Values["id"].ToString() }) %>' runat="server" Text="&times;" />
                </div>
            </asp:PlaceHolder>
            ...
            <asp:FormView ID="BookletEditFormView" runat="server"
                ...
                DefaultMode="Edit"
                UpdateMethod="BookletEditFormView_UpdateItem"
                SelectMethod="BookletEditFormView_GetItem"
                RenderOuterTable="false"
                OnPreRender="BookletEditFormView_PreRender">
                    ...
                    <div class="booklet-details-card-other small-12 columns">
                        ...
                        <div class="booklet-details-card-buttons small-12 medium-3 large-3 columns">
                            <ul class="button-list">
                                ...
                                <li>
                                    <asp:LinkButton ID="SaveLinkButton" CssClass="button" CommandName="Update" ToolTip="Spara ändringar" runat="server" CausesValidation="true">
